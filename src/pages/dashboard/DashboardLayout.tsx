...
export function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[--color-bg]">
      <aside className="hidden w-60 flex-col border-r border-[--color-border-subtle] bg-white/90 px-5 py-6 shadow-sm backdrop-blur md:flex">
        ...
        <div className="brand-block mt-auto rounded-2xl p-4 text-xs">
          ...
          <p className="mt-2 text-[11px] opacity-90">750 / 1000 codes</p>
        </div>
      </aside>

      <main className="flex min-h-screen flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-[--color-border-subtle] bg-white/80 px-4 py-4 backdrop-blur md:px-8">
          <div>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden items-center gap-2 rounded-full bg-slate-50 px-3 py-1.5 text-xs text-[--color-text-muted] md:flex">
              <span>🔍</span>
              <input
                placeholder="Search codes..."
                className="border-none bg-transparent text-xs outline-none placeholder:text-[--color-text-muted]"
              />
            </div>
            <button className="btn-primary hidden h-9 rounded-xl px-4 text-xs md:inline-flex">
              Create New
            </button>
